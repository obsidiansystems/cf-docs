...
{/* GENERATED_FROM source="digital-asset/canton" ref="v3.5.14" path="docs-open/src/sphinx/participant/reference/metrics.rst" */}
...
### daml.participant.traffic-enforcement.not-enough-traffic
