...
Rather than [Listing_all_Validators](/sdks-tools/api-reference/splice-scan-gs-connectivity-api), which can yield a large number of irrelevant records, /v0/validators/validator-faucets?validator_ids=... yields only liveness information about the specified validators.
